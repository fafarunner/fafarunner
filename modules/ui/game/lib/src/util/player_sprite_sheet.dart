...
class PlayerSpriteSheet {
  ...
  static Future<SpriteAnimation> attackEffectBottom() => SpriteAnimation.load(
    Assets
        ...
        .keyName, // 'player/player_atack_effect_bottom.png'
    SpriteAnimationData.sequenced(
      amount: 6,
      stepTime: 0.1,
      textureSize: Vector2(16, 16),
  ...
  static Future<SpriteAnimation> attackEffectLeft() => SpriteAnimation.load(
    Assets
        ...
        .keyName, // 'player/player_atack_effect_left.png'
    SpriteAnimationData.sequenced(
      amount: 6,
      stepTime: 0.1,
      textureSize: Vector2(16, 16),
  ...
  static Future<SpriteAnimation> attackEffectRight() => SpriteAnimation.load(
    Assets
        ...
        .keyName, // 'player/player_atack_effect_right.png'
    SpriteAnimationData.sequenced(
      amount: 6,
      stepTime: 0.1,
      textureSize: Vector2(16, 16),
  ...
  static Future<SpriteAnimation> attackEffectTop() => SpriteAnimation.load(
    Assets
        ...
        .keyName, // 'player/player_atack_effect_top.png'
    SpriteAnimationData.sequenced(
      amount: 6,
      stepTime: 0.1,
      textureSize: Vector2(16, 16),
      ...
      SimpleDirectionAnimation(
        idleLeft: SpriteAnimation.load(
          Assets
              ...
              .player
              .knightIdleLeft
              .keyName, // 'player/knight_idle_left.png'
          SpriteAnimationData.sequenced(
            amount: 6,
            stepTime: 0.1,
            textureSize: Vector2(16, 16),
        ...
        runLeft: SpriteAnimation.load(
          Assets
              ...
              .player
              .knightRunLeft
              .keyName, // 'player/knight_run_left.png'
          SpriteAnimationData.sequenced(
            amount: 6,
            stepTime: 0.1,
            textureSize: Vector2(16, 16),
