...
class EnemySpriteSheet {
  static Future<SpriteAnimation> enemyAttackEffectBottom() =>
      SpriteAnimation.load(
        Assets
            ...
            .enemy
            .atackEffectBottom
            .keyName, // 'enemy/atack_effect_bottom.png'
  ...
  static Future<SpriteAnimation> enemyAttackEffectLeft() =>
      SpriteAnimation.load(
        Assets
            ...
            .enemy
            .atackEffectLeft
            .keyName, // 'enemy/atack_effect_left.png'
        SpriteAnimationData.sequenced(
          amount: 6,
          stepTime: 0.1,
          textureSize: Vector2(16, 16),
  ...
  static Future<SpriteAnimation> enemyAttackEffectRight() =>
      SpriteAnimation.load(
        Assets
            ...
            .enemy
            .atackEffectRight
            .keyName, // 'enemy/atack_effect_right.png'
        SpriteAnimationData.sequenced(
          amount: 6,
          stepTime: 0.1,
          textureSize: Vector2(16, 16),
  ...
  static SimpleDirectionAnimation bossAnimations() => SimpleDirectionAnimation(
    idleLeft: SpriteAnimation.load(
      Assets
          ...
          .boss
          .bossIdleLeft
          .keyName, // 'enemy/boss/boss_idle_left.png'
      SpriteAnimationData.sequenced(
        amount: 4,
        stepTime: 0.1,
        textureSize: Vector2(32, 36),
    ...
    runLeft: SpriteAnimation.load(
      Assets
          ...
          .boss
          .bossRunLeft
          .keyName, // 'enemy/boss/boss_run_left.png'
      SpriteAnimationData.sequenced(
        amount: 4,
        stepTime: 0.1,
        textureSize: Vector2(32, 36),
    ...
    runRight: SpriteAnimation.load(
      Assets
          ...
          .boss
          .bossRunRight
          .keyName, // 'enemy/boss/boss_run_right.png'
      SpriteAnimationData.sequenced(
        amount: 4,
        stepTime: 0.1,
        textureSize: Vector2(32, 36),
  ...
  static Future<SpriteAnimation> goblinIdleRight() => SpriteAnimation.load(
    Assets
        ...
        .goblin
        .goblinIdle
        .keyName, // 'enemy/goblin/goblin_idle.png'
    SpriteAnimationData.sequenced(
      amount: 6,
      stepTime: 0.1,
      textureSize: Vector2(16, 16),
      ...
      SimpleDirectionAnimation(
        idleLeft: SpriteAnimation.load(
          Assets
              ...
              .goblin
              .goblinIdleLeft
              .keyName, // 'enemy/goblin/goblin_idle_left.png'
          SpriteAnimationData.sequenced(
            amount: 6,
            stepTime: 0.1,
            textureSize: Vector2(16, 16),
        ...
        runLeft: SpriteAnimation.load(
          Assets
              ...
              .goblin
              .goblinRunLeft
              .keyName, // 'enemy/goblin/goblin_run_left.png'
          SpriteAnimationData.sequenced(
            amount: 6,
            stepTime: 0.1,
            textureSize: Vector2(16, 16),
        ...
        runRight: SpriteAnimation.load(
          Assets
              ...
              .goblin
              .goblinRunRight
              .keyName, // 'enemy/goblin/goblin_run_right.png'
          SpriteAnimationData.sequenced(
            amount: 6,
            stepTime: 0.1,
            textureSize: Vector2(16, 16),
  ...
  static SimpleDirectionAnimation impAnimations() => SimpleDirectionAnimation(
    idleLeft: SpriteAnimation.load(
      Assets
          ...
          .imp
          .impIdleLeft
          .keyName, // 'enemy/imp/imp_idle_left.png'
      SpriteAnimationData.sequenced(
        amount: 4,
        stepTime: 0.1,
        textureSize: Vector2(16, 16),
    ...
    runLeft: SpriteAnimation.load(
      Assets
          ...
          .imp
          .impRunLeft
          .keyName, // 'enemy/imp/imp_run_left.png'
      SpriteAnimationData.sequenced(
        amount: 4,
        stepTime: 0.1,
        textureSize: Vector2(16, 16),
    ...
    runRight: SpriteAnimation.load(
      Assets
          ...
          .imp
          .impRunRight
          .keyName, // 'enemy/imp/imp_run_right.png'
      SpriteAnimationData.sequenced(
        amount: 4,
        stepTime: 0.1,
        textureSize: Vector2(16, 16),
  ...
  static Future<SpriteAnimation> miniBossIdleRight() => SpriteAnimation.load(
    Assets
        ...
        .miniBoss
        .miniBossIdle
        .keyName, // 'enemy/mini_boss/mini_boss_idle.png'
    SpriteAnimationData.sequenced(
      amount: 4,
      stepTime: 0.1,
      ...
      SimpleDirectionAnimation(
        idleLeft: SpriteAnimation.load(
          Assets
              ...
              .miniBoss
              .miniBossIdleLeft
              .keyName, // 'enemy/mini_boss/mini_boss_idle_left.png'
          SpriteAnimationData.sequenced(
            amount: 4,
            stepTime: 0.1,
            textureSize: Vector2(16, 24),
        ...
        runLeft: SpriteAnimation.load(
          Assets
              ...
              .miniBoss
              .miniBossRunLeft
              .keyName, // 'enemy/mini_boss/mini_boss_run_left.png'
          SpriteAnimationData.sequenced(
            amount: 4,
            stepTime: 0.1,
            textureSize: Vector2(16, 24),
        ...
        runRight: SpriteAnimation.load(
          Assets
              ...
              .miniBoss
              .miniBossRunRight
              .keyName, // 'enemy/mini_boss/mini_boss_run_right.png'
          SpriteAnimationData.sequenced(
            amount: 4,
            stepTime: 0.1,
            textureSize: Vector2(16, 24),
